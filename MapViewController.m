...
- (void)viewDidLoad
{
  ...
  //  MKCoordinateSpan span = MKCoordinateSpanMake(180.0000f, 180.0000f);
    ...
    greenland.information = @"\rGreenland is an examplar of the effects of climate change. The glacial sheet is melting at a rate that climatologists warn could adversely affect millions living in coastal regions. \r\rFurther Reference:\rCatholic Climate Movement\rhttp://tinyurl.com/lxe52t7\r\rNational Snow & Ice Data Center, “Greenland Ice Sheet Today”\rhttp://tinyurl.com/a422blp\r\rCoordinates: 50.0000, -40.0000\r\r\r";
    ...
    greatbr.information = @"\rAustralia's Great Barrier Reef is the world's largest coral ecosystem. Climate change is putting many elements of the reef under threat.\r\rFurther Reference:\rCatholic Bishops of Queensland, “Pastoral Letter on the Great Barrier Reef”\rhttp://tinyurl.com/one2fma\r\rCatholic Care Australia\rhttp://catholicearthcare.org.au\r\rCoordinates:\r18.2861, 147.7000\r\r\r";
    ...
    camden.information = @"\rCoordinates: 39.9400, -75.1050\r\r\r";
    ...
    atlantic.information = @"\rThe Atlantic Ocean is the 2nd largest ocean in the world, after the Pacific Ocean. It includes the Gulf Stream and North Atlantic Drift currents. These waterways could be adversely affected by increasing levels of fresh water, causing acccelerated sea level rise, hypoxia, and desalinization.\r\rFurther Reference:\rWikipedia, “Atlantic Ocean”\rhttp://tinyurl.com/sea3p\r\rDonate to Catholic Relief Services\rhttp://www.crs.org/donate/\r\rCoordinates: 38.4667, -28.4000\r\r\r";
...
- (IBAction)mapsButton:(id)sender
{
    ...
    UIAlertAction* socialAction = [UIAlertAction actionWithTitle:@"Social" style:UIAlertActionStyleDefault
                                     ...
                                     philippines.image = [UIImage imageNamed:@"legazpi"];
                                     philippines.subtitle = @"Carbon Mining Coastal Destruction";
                                     philippines.information = @"The coast of Legazpi City, Philippines, is suffering from the effects of carbon mining.\r\r\r";
                                     ...
                                     camden.subtitle = @"Issue: Systemic Poverty";
                                         ...
                                         atlantic.subtitle = @"Rising Water Levels";
                                         atlantic.image = [UIImage imageNamed:@"ocean"];
                                         atlantic.information = @"\rThe Atlantic Ocean is the 2nd largest ocean in the world, after the Pacific Ocean. It includes the Gulf Stream and North Atlantic Drift currents. These waterways could be adversely affected by increasing levels of fresh water, causing acccelerated sea level rise, hypoxia, and desalinization.\r\rFurther Reference:\rWikipedia, “Atlantic Ocean”\rhttp://tinyurl.com/sea3p\r\rCoordinates: 38.4667, -28.4000\r\r\r";
