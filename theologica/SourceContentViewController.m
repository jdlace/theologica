...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([segue.identifier isEqualToString:@"scriptureDetail"])
        ...
        creedsSource.comment = @"\rThe Creeds of the Church give expression to the Faith of the Church. Instead of being viewed as exhaustive statements of the Faith, it is more helpful to view the historic Creeds as a set of parameters against which Catholic orthodoxy is determined.\r\r\r";
