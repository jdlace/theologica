...
- (void)buildDictionaryWords
{
    ...
    */
    ...
    [TAWord wordWithDict:@{@"name":@"Adonai",
                           @"twitterDef":@"the Hebrew word meaning “Master” or “Lord”",
    ...
    [TAWord wordWithDict:@{@"name":@"Anthropomorphism",
                           ...
                           @"definition":@"\rGod is described in human terms throughout the Christian tradition, and especially within the Scriptures. The Yahwist Source uses anthropomorphism extensively in its portrayal of Yahweh in the Torah. Such language is, however, ultimately, only analogous to God. Pope John Paul II claimed that various modes of expression are used within the Scriptures:\r\r“Speaking about himself, whether through the prophets, or through the Son' (cf. Heb 1:1, 2) who became man, God speaks in human language, using human concepts and images. If this manner of expressing himself is characterized by a certain anthropomorphism, the reason is that man is 'like' God: created in his image and likeness. But then, God too is in some measure 'like man', and precisely because of this likeness, he can be humanly known.”\r-Mulierus Dignatatum, 8\r\rSee “Analogy”, “Yahwist Source”, “Yahweh”.\r\rFurther Reference:\rPope John Paul II, “Mulierus Dignatatem”\rhttp://tinyurl.com/nphq2r6\r\r\r",
                           @"category":@"Biblical"}];
    
    [TAWord wordWithDict:@{@"name":@"Annunciation",
                           @"twitterDef":@"the angelic declaration to Mary that she would bear the Son of God",
                           @"definition":@"\rThe Annunciation is found in the first chpater of the Gospel of Luke:\r\r“In the sixth month, the angel Gabriel was sent from God to a town of Galilee called Nazareth, to a virgin betrothed to a man named Joseph, of the house of David, and the virgin’s name was Mary. And coming to her, he said, 'Hail, favored one! The Lord is with you.' But she was greatly troubled at what was said and pondered what sort of greeting this might be. Then the angel said to her, 'Do not be afraid, Mary, for you have found favor with God. Behold, you will conceive in your womb and bear a son, and you shall name him Jesus. He will be great and will be called Son of the Most High, and the Lord God will give him the throne of David his father, and he will rule over the house of Jacob forever, and of his kingdom there will be no end.' But Mary said to the angel, 'How can this be, since I have no relations with a man?' And the angel said to her in reply, 'The holy Spirit will come upon you, and the power of the Most High will overshadow you. Therefore the child to be born will be called holy, the Son of God. And behold, Elizabeth, your relative, has also conceived a son in her old age, and this is the sixth month for her who was called barren; for nothing will be impossible for God.' 38 Mary said, 'Behold, I am the handmaid of the Lord. May it be done to me according to your word.' Then the angel departed from her.”\r-Luke 1:26-38\r\rThis section in Luke's infancy narrative follows the Old Testament trope of angelic communications before the birth of important figures. In his homilies on Luke, Origen of Alexandria emphasized that the Greek word κεχαριτωμένη (kecharitomene) occurs in Scripture only once, in this reference to Mary's singular status. Many modern Catholic writers would see in this passage the beginnings of the dogma of the Immaculate Conception. See “Angel”, “Immaculate Conception”, “Synoptic Gospels”.\r\rFurther Reference:\rCatechism of the Catholic Church, 484\rhttp://tinyurl.com/3w9q9aw\r\rNew American Bible Revised Edition\rGospel of Luke\rhttp://tinyurl.com/zw8gatc\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Act",
                           ...
                           @"definition":@"\rIn moral theology, an truly “human” act refers to actions made with freedom and will for which one is responsible. See “Free Will”.\r\rFurther Reference:\rCatholic Moral Theology blog\rhttp://tinyurl.com/pyfcn3n\r\r\r",
                           @"category":@"Moral"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Annointing of the Sick",
                           ...
                           @"definition":@"\rThe Annointing of the Sick has its roots in the healing ministry of Jesus and the early Christians. It is referred to specifically in the New Testament Letter of James:\r\r“Is anyone among you sick? He should summon the presbyters of the church, and they should pray over him and anoint with oil in the name of the Lord, and the prayer of faith will save the sick person, and the Lord will raise him up. If he has committed any sins, he will be forgiven. Therefore, confess your sins to one another and pray for one another, that you may be healed. The fervent prayer of a righteous person is very powerful.”\r-James 5: 14-16\r\rSee “Sacrament”.\r\rFurther Reference:\rCatechism of the Catholic Church, 1499\rhttp://tinyurl.com/n3lyve9\r\rNew American Bible Revised Edition, Letter of James\rhttp://tinyurl.com/gnqrjqk\r\r\r",
                           @"category":@"Liturgical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Amen",
                           ...
                           @"definition":@"\rThe Amen is traditionally said after a prayer as a form of agreement. It derives from Jewish use in the synagogue and later in the New Testament where it is used to indicate the truthfulness of what is said. “Amen, I say to you...” is a sayings formula used throughout the Gospels used to emphasize the truth of Jesus' teachings.\r\rHebrew, אָמֵן (amen)\r\rFurther Reference:\rCatechism of the Catholic Church, 1061\rhttp://tinyurl.com/k3f2f8p\r\rFelix Just\r“Amen, Amen Sayings in the Fourth Gospel”\rhttp://tinyurl.com/k545gaq\r\r\r",
                           @"category":@"Liturgical"}];
    
    [TAWord wordWithDict:@{@"name":@"Anamnesis",
                           @"twitterDef":@"the Greek word meaning “lived rememberance”",
                           @"definition":@"\rThe concept of anamnesis was first used by Plato as an epistemological explanation of how human beings have knowledge via the remembering of forgotten truths known in a former life. The writers of the Synoptic Gospels use it the Passion Narrative during the Words of Institution, in which Jesus asks his disciples to “remember” him when they eat the bread and drink the cup. It is a performative act used to re-present the salvific death and resurrection of Jesus.  See “Passion Narrative”, “Real Presence”, “Synoptic Gospels”, “Words of Institution”.\r\rGreek, ἀνάμνησις (anamnesis)\r\rFurther Reference:\rCatechism of the Catholic Church, 1103\rhttp://tinyurl.com/oqbzkx3\r\r\r",
                           @"category":@"Liturgical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Angel",
                           ...
                           @"definition":@"\rAngels are found througout the Scriptures, and their existence is affirmed by the Church as a truth of the faith. Post-Exilic Judaism had developed an intricate angeology by the first century. Jesus alludes to the idea that some angels have been assigned responsibility for the care of specific individuals (i.e. the concept of “gaurdian angels”. The Bible mentions different classes of angels, with Cherubim being the highest. See “Divine Revelation”.\r\rGreek, ἄγγελος (angelos) “messenger”\r\rFurther Reference:\rCatechism of the Catholic Church, 327\rhttp://tinyurl.com/qcujkzy\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Agnostic",
                           ...
                           @"definition":@"\rUncertainty about the reality of God is quite common among modern people in various societies. For some, an agnostic worldview is one that is an epistemological necessity given the unknowability of God. Agnostics are sometimes mistakenly confused with atheists, but can often be conflated with those who are indifferent to the question of God.\r\rFurther Reference:\rCatechism of the Catholic Church, 2127\rhttp://tinyurl.com/lu75a9k\r\r\r",
                           @"category":@"Cultural"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Biblical Novellas",
                           @"twitterDef":@"the third of five sections in the Old Testament that contains short stories designed to encourage persecuted Israelites",
    ...
    [TAWord wordWithDict:@{@"name":@"Babel",
                           ...
                           @"definition":@"\rAs an etiology, this story explains both how human language became divided as well as the geographic distribution of human populations. A parallel story exists in ancient Sumerian literature as Enmerkar and Lord of Aratta. See “Etiology”.\r\rHebrew, בָּבֶל (babel)\r\rFurther Reference:\rCatechism of the Catholic Church, 57\rhttp://tinyurl.com/k6ljesq\r\rEnmerkar and the Lord of Aratta\rhttp://tinyurl.com/h7s9w9l\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Big Bang Theory",
                           ...
                           @"definition":@"\rThe cosmological theory, first developed by Fr. George Lemaitre, that claims that the Universe began at an infintely small and dense point of matter, energy, space, and time which then expanded over the course of time to become the observable cosmos we see today. The International Theological Commission (ITC) observed that this well-tested theory is compatible with the doctrine of Creation:\r\r“According to the widely accepted scientific account, the universe erupted 15 billion years ago in an explosion called the 'Big Bang' and has been expanding and cooling ever since. Later there gradually emerged the conditions necessary for the formation of atoms, still later the condensation of galaxies and stars, and about 10 billion years later the formation of planets...With respect to the creatio ex nihilo, theologians can note that the Big Bang theory does not contradict this doctrine insofar as it can be said that the supposition of an absolute beginning is not scientifically inadmissible. Since the Big Bang theory does not in fact exclude the possibility of an antecedent stage of matter, it can be noted that the theory appears to provide merely indirect support for the doctrine of creatio ex nihilo which as such can only be known by faith.”\r-ITC, 63, 67\r\rSee “Creation”.\r\rFurther Reference:\rInternational Theological Commission,\r“Communion & Stewardshp”\rhttp://tinyurl.com/c37p5\r\rStephen Barr, “Modern Physics, the Beginning, and Creation” (video)\rhttp://tinyurl.com/zp9emwl\r\rWikipedia, “Big Bang”\rhttp://tinyurl.com/9nq4k\r\r\r",
                           @"category":@"Cultural"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Cosmology",
                          @"twitterDef":@"a given view of the Universe;\nthe study of the large scale properties of the Universe",
                          @"definition":@"\rHow the biblical writers viewed the Universe directly impacted the way in which they composed their stories and their view of the human condition. For example, the Priestly author of Genesis 1 viewed the Universe in geocentic terms, with the flat Earth encircled by the sun, moon, and stars, the nature of which was static. The New Testament holds a similar view of nature and the Universe. Later Christian thinkers, such as Aquinas, would fuse Aristotelean physics with the biblical drama of salvation to produce a theo-cosmology that found its ultimate expression in Dante's Divine Comedy. Modern cosmologies view the the Univese and nature as dynamic and evolving. See “Evolution”, “Priestly Source”.\r\rFurther Reference:\rPBS Counterbalance, “Cosmology”\rhttp://tinyurl.com/64bvhy\r\r\r",
                          @"category":@"Cultural"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Crucifixion",
                           ...
                           @"definition":@"\rThe Romans aquired the practice of crucifixion from the Carthaginians. It was reserved for Roman non-citizens.\r\rFurther Reference:\rPBS: “From Jesus To Christ”, Crucifixion (video)\rhttp://tinyurl.com/gp2cxrr\r\rWikipedia, “Crucifixion of Jesus”\rhttp://tinyurl.com/b474qw\r\r\r",
                           @"category":@"Biblical"}];
    ...
    */
    ...
    [TAWord wordWithDict:@{@"name":@"Cybertheology",
                           ...
                           @"definition":@"\rAccording to Fr. Antonio Spadaro, the term “cybertheology” refers to the intelligence of faith in the era of the Internet and World Wide Web, which arises from the recognition that, as technology changes ways of thinking, theology necessarily changes as well. Msgr. Paul Tighe, the Adjunct Secretary of the Pontifical Council for Culture, has observed:\r\r“The combination of these developments in mobile telephony, computer technology, fiber-optics and satellites mean that many of us now carry with us devices that allow us instant access to an extra-ordinary range of information, news and opinion from around the globe and that enable us to communicate by word, text or the sharing of images with people and institutions in every corner of the world. This revolution in information and communication technologies, however, cannot be adequately understood merely in instrumental terms: it is not simply a question of communication and the exchange of information growing in terms of volume, speed, efficiency and accessibility; but rather that we are also witnessing concomitant changes in the ways in which people use these technologies to communicate, learn and interact - we are living through a change of paradigm in the very culture of communication.”\r-Tighe, “Challenge”\r\rFurther Reference:\rFr. Antonio Spadaro, “Cybertelogia”\rhttp://tinyurl.com/kuxll8z\r\rMsgr. Paul Tighe\r“The Challenge for the Church in a Digital Culture”\rhttp://tinyurl.com/jx6s5ap\r\rInterview with Msgr. Paul Tighe\r“The New Media Revolution” (video)\rhttp://tinyurl.com/j8cv5wz\r\r\r",
                           @"category":@"Systematic"}];
   ...
   // [TAWord wordWithDict:@{@"name":@"Deanery",
    ...
    [TAWord wordWithDict:@{@"name":@"Deuteronomic Code",
                           @"twitterDef":@"a legal code found in Deuteronomy 12-26",
    ...
    [TAWord wordWithDict:@{@"name":@"Deuteronomic Source",
                           ...
                           @"definition":@"\rThe “D” source is one of the four sources which compose the Torah. It is based around the Deuteronomic Source. According to Richard Elliot Freidman, the author of D was most likely the prophet Jeremiah. See “Documentary Hypothesis”, “Deuteronomic Source”.\r\rFurther Reference:\rWikipedia, “Deuteronomist”\rhttp://tinyurl.com/myayczm\r\r\r",
                           @"category":@"Biblical"}];
    ...
    */
    ...
    [TAWord wordWithDict:@{@"name":@"Docetism",
                           ...
                           @"definition":@"\rDocetism is a form of Gnosticism, and as such, denied the full humanity of Jesus Christ. It is alluded to in the Johonnine epistolary corpus. See “Heresy”.\r\rGreek, δοκεῖν (dokein) “to seem”\r\rFurther Reference:\rCatechism of the Catholic Church, 465\rhttp://tinyurl.com/37wuaux\r\r\r",
                           @"category":@"Historical"}];
    
    [TAWord wordWithDict:@{@"name":@"Donatism",
                           @"twitterDef":@"a schismatic Christian group that denied the principle of ex opere operato",
                           @"definition":@"\rThe Donatist schism began in A.D. 311 in North Africa and flourished for about one hundred years. It began when Donatus, a bishop in the church of Carthage, was elected as a reaction against the election of Caecilian to the episcopacy. The latter had been consecrated by a traitor under the Diocletian persecution. Donatus declared all sacraments and ordinations by Caecilian to be invalid and caused a schism in Northern Africa. In 313, a local council ruled against the rigorism of Donatus. St. Augustine argued against the Donatist rigorism on the basis that the sacraments are effective regardless of the personal holiness of the celebrant. See “Ex Opere Operato”, “Schism”.\r\rFurther Reference:\rCatechism of the Catholic Church, 1128\rhttp://tinyurl.com/cmes38\r\r\r",
                           @"category":@"Historical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Economic Justice",
                           @"twitterDef":@"the right relationship between human beings and their economy based on the dignity of the human person",
                           @"definition":@"\rEconomic justice is based on the idea that the economy of any society should serve people, not vice versa. See “Justice”.\r\rFurther Reference:\rUnited States Conference of Catholic Bishops\r“Economic Justice For All”. http://tinyurl.com/75hnlx3\r\r\r",
                           @"category":@"Moral"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Epic of Gilgamesh",
                           @"twitterDef":@"an ancient Sumerian epic that parallels and predates the biblical flood stories",
                           @"definition":@"\rDiscovered in 1853, this story is considered by many scholars to be the earliest piece of human literature. It dates back to 2100 B.C. during the Third Dynasty of Ur in Mesapotamia. Tablet XI contains the relevant parallel:\r\r“Utanapishtim spoke to Gilgamesh, saying: “I will reveal to you, Gilgamesh, a thing that is hidden, a secret of the gods I will tell you! Shuruppak, a city that you surely know, situated on the banks of the Euphrates, that city was very old, and there were gods inside it. The hearts of the Great Gods moved them to inflict the Flood…O man of Shuruppak, son of Ubartutu: Tear down the house and build a boat! Abandon wealth and seek living beings! Spurn possessions and keep alive living beings! Make all living beings go up into the boat. The boat which you are to build, its dimensions must measure equal to each other: its length must correspond to its width. Roof it over like the Apsu…Just as dawn began to glow the land assembled around me-the carpenter carried his hatchet, the reed worker carried his (flattening) stone…the men…The child carried the pitch, the weak brought whatever else was needed. On the fifth day I laid out her exterior. It was a field in area, its walls were each 10 times 12 cubits in height, the sides of its top were of equal length, 10 times It cubits each. I laid out its (interior) structure and drew a picture of it. I provided it with six decks, thus dividing it into seven (levels)…All the living beings that I had I loaded on it, I had all my kith and kin go up into the boat, all the beasts and animals of the field and the craftsmen I had go up. Shamash had set a stated time: ‘In the morning I will let loaves of bread shower down, and in the evening a rain of wheat! Go inside the boat, seal the entry!’…Six days and seven nights came the wind and flood, the storm flattening the land. When the seventh day arrived, the storm was pounding, the flood was a war–struggling with itself like a woman writhing (in labor). The sea calmed, fell still, the whirlwind (and) flood stopped up. I looked around all day long–quiet had set in and all the human beings had turned to clay! The terrain was as flat as a roof. I opened a vent and fresh air fell upon the side of my nose. I fell to my knees and sat weeping, tears streaming down the side of my nose. I looked around for coastlines in the expanse of the sea, and at twelve leagues there emerged a region (of land). On Mt. Nimush the boat lodged firm, Mt. Nimush held the boat, allowing no sway. One day and a second Mt. Nimush held the boat, allowing no sway. A third day, a fourth, Mt. Nimush held the boat, allowing no sway. A fifth day, a sixth, Mt. Nimush held the boat, allowing no sway. When a seventh day arrived I sent forth a dove and released it. The dove went off, but came back to me; no perch was visible so it circled back to me. I sent forth a swallow and released it. The swallow went off, but came back to me; no perch was visible so it circled back to me. I sent forth a raven and released it. The raven went off, and saw the waters slither back. It eats, it scratches, it bobs, but does not circle back to me. Then I sent out everything in all directions and sacrificed. I offered incense in front of the mountain-ziggurat. Seven and seven cult vessels I put in place, and (into the fire) underneath (into their bowls) I poured reeds, cedar, and myrtle. The gods smelled the savor, the gods smelled the sweet savor, and collected like flies over a sacrifice.”\r-Gilgamesh, XI\r\rSee “Atrahasis Myth”, “Primeval Hebrew Myth”.\r\rFurther Reference:\rEpic of Gilgamesh\rhttp://tinyurl.com/j33dgu7\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Ex Opere Operato",
                           ...
                           @"definition":@"\rThe Donatist Schism was initiated by a refusal of Donatus and his followers to adhere to this teaching. St. Augustine argued that the sacraments are efficacious apart from the personal holiness of the celebrant. See “Donatism”, “Ex Opere Operantis”.\r\rLatin, (ex opere operato) “from the work, worked”\r\rFurther Reference:\rCatechism of the Catholic Church, 1128\rhttp://tinyurl.com/cmes38\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Ex Opere Operantis",
                           ...
                           @"definition":@"\rThis phrase refers to the emphasis on the subjective character of the celebrant. In the Catholic tradition, it does not affect the validity of the Sacraments. See “Donatism”, “Ex Opere Operato”.\r\rLatin, (ex opere operantis) “from the work of the worker”\r\rFurther Reference:\rCatechism of the Catholic Church, 1128\rhttp://tinyurl.com/cmes38\r\r\r\r",
                           @"category":@"Systematic"}];
   ...
   //////////////////////////////////////////F
    ...
    [TAWord wordWithDict:@{@"name":@"Free Will",
                           ...
                           @"definition":@"\rFree will has traditionally been interpreted as a characteristic of human nature being made in the Image of God. The degree of freedom of the will is a factor in analyzing the morality of certain acts. Impediments (both virtual and habitual) can mitigate both responsibility and morality of human actions:\r\r“Imputability and responsibility for an action can be diminished or even nullified by ignorance, inadvertence, duress, fear, habit, inordinate attachments, and other psychological or social factors.”\r-Catechism, 1735\r\rThe recent work of philosophers such as Alasdair MacIntyre have emphasized the necessary neuro-psychological context for reflection upon free will:\r\r“Consider how both physical and mental disability are afflictions of the body and how therefore habits of mind that express an attitude of denial towards the facts of disability and dependence presuppose either a failure or a refusal to acknowledge adequately the bodily dimensions of our existence...We become in consequence forgetful of our bodies and of how our thinking is the thinking of one species of animal.”\rMacIntyre, 4-5\r\rFurther Reference:\rCatechism of the Catholic Church, 1731-1742\rhttp://tinyurl.com/qzj6nl9\r\rAlasdair MacIntyre, “Dependent Rational Animals”\rhttp://tinyurl.com/hcpy5hw\r\rNancey Murphy, “The Brain and Being Human” (video)\rhttp://tinyurl.com/hlfxa68\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Historicity",
                           @"twitterDef":@"the relativizing effect of historical context on interpretation",
                           @"definition":@"\rBernard Lonergan developed his 4 majori theses concerning historicity:\r\r1. Human concepts are derivitive of human understanding.\r2. Understanding changes over time.\r3. These changes are cumulative.\r4. These changes may not happen sychronously.\r\rSee “Histoical-Critical Method”.\r\rFurther Reference:\rPontifical Biblical Commission\r“The Interpretation of the Bible in the Church”\rhttp://tinyurl.com/nmj6amr\r\r\r",
                           @"category":@"Biblical"}];
    ...
    */
    ...
    [TAWord wordWithDict:@{@"name":@"Imago Dei",
                           @"twitterDef":@"the sacred status given to human beings in Genesis 1:26-27",
                           @"definition":@"\rAccording to the Priestly creation account in Genesis chapter 1:26-27:\r\r“Then God said, 'Let us make mankind in our image, in our likeness, so that they may rule over the fish in the sea and the birds in the sky, over the livestock and all the wild animals, and over all the creatures that move along the ground.' So God created mankind in his own image, in the image of God he created them; male and female he created them.“\r\rVarious Church Fathers have interpreted this passage to mean that human beings have a speical status among other creatures, consisting of free-will and reason. See “Priestly Source“, “Theological Anthropology“.\r\rLatin, (imago dei) “Image of God”\r\rFurther Reference:\rCatechism of the Catholic Church, 1701\rhttp://tinyurl.com/p62m9rv\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Jus Ad Bellum",
                           ...
                           @"definition":@"\rThe criteria for justifying the decision of a nation to initiate war against another include:\r\r-Just Cause\r-Comparative Justice\r-Competent Authority\r-Right Intention\r-Probability of Success\r-Last Resort\r-Proportionality\r\rFor the proposed military action to be justified, all seven of the criteria must be satisfied.\r\rSee “Just War Theory”.\r\rLatin, (jus ad bellum) “justice to war”\r\rFurther Reference:\rStanford Encyclopedia of Philosophy, “War”\rhttp://tinyurl.com/84c2ppg\r\r\r",
                           @"category":@"Moral"}];
    
    [TAWord wordWithDict:@{@"name":@"Jus Im Bello",
                           @"twitterDef":@"a set of criteria used to determine if the methods of war are justified",
                           @"definition":@"\rThe criteria for determining whether or not military actions within a given war are ethical include:\r\r-Distinction\r-Proportionality\r-Military Necessity\r-Fair Treatment of Prisoners\r-Avoidance Intrinsicly Evil Acts\r\rSee “Just War Theory”.\r\rLatin, (jus im bello) “justice in war”\r\rFurther Reference:\rStanford Encyclopedia of Philosophy, “War”\rhttp://tinyurl.com/84c2ppg\r\r\r",
                           @"category":@"Moral"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Just War Theory",
                           ...
                           @"definition":@"\rThe theory first developed by Augustine and later refined by Aquinas which consists of criteria for determining the justice of both the conditions for and methods of war. The Compendium of the Social Doctrine of the Church summarizes the essential points of the theory also found in the Catechism:\r\r“A war of aggression is intrinsically immoral. In the tragic case where such a war breaks out, leaders of the State that has been attacked have the right and the duty to organize a defence even using the force of arms. To be licit, the use of force must correspond to certain strict conditions: “the damage inflicted by the aggressor on the nation or community of nations must be lasting, grave and certain; all other means of putting an end to it must have been shown to be impractical or ineffective; there must be serious prospects of success; the use of arms must not produce evils and disorders graver than the evil to be eliminated. The power of modern means of destruction weighs very heavily in evaluating this condition. These are the traditional elements enumerated in what is called the ‘just war' doctrine. The evaluation of these conditions for moral legitimacy belongs to the prudential judgment of those who have responsibility for the common good.”\r-Compendium, 500\r\rSee “Jus Ad Bellum”, “Jus Im Bello”.\r\rFurther Reference:\rCompendium of the Social Doctrine of the Church, 500\rhttp://tinyurl.com/jn4r3vz\r\rCatechism of the Catholic Church, 2309\rhttp://tinyurl.com/dh7r\r\rStanford Encyclopedia of Philosophy, “War”\rhttp://tinyurl.com/84c2ppg\r\r\r",
                           @"category":@"Moral"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Merneptah Stele",
                           ...
                           @"definition":@"\rPharoah Merneptah ruled Egypt from 1213-1203 B.C. As was customary in the ancient world, he used large stone slabs (steles) to boast about his military victories. The inscription, discovered in Thebes in 1896, has been dated to the year 1208 B.C. and claims:\r\r“The Canaan has been plundered into every sort of woe: Ashkelon has been overcome; Gezer has been captured; Yano'am is made non-existent. Israel is laid waste and his seed is not...”\r\rFurther Reference:\rOxford Research Encyclopedias:\r“History of Ancient Israel”\rhttp://tinyurl.com/ja8q2uc\r\r\r",
                           @"category":@"Biblical"}];
    
    [TAWord wordWithDict:@{@"name":@"Method of Correlation",
                           @"twitterDef":@"a theological method that correlates the meaning of human experience with the meaning of Divine Revelation",
                           @"definition":@"\rThe Method of Correlation is a theme of both neo-orthodox and revisionist theologies as seen in the work of recent theologians such as Paul Tillich, Bernard Lonergan, and David Tracy. It presents the theological task as one of constant interpretation of the message of the Christianity within a given historical and cultural situation. See “Theology”.\r\rFurther Reference:\rDavid Tracy, “The Uneasy Alliance Reconceived: Catholic Theological Method, Modernity, and Postmodernity”\rhttp://tinyurl.com/pcnzx7s\r\r\r",
                           @"category":@"Systematic"}];
    
    [TAWord wordWithDict:@{@"name":@"Midrash",
                           @"twitterDef":@"a form of rabbinic literature that explores ethical interpretation of Torah through narrative",
                           @"definition":@"\rMidrash may consist of exegesis of legal texts (halakhic) as well as homilies (haggadic) that attempt to offer further explanation of people and events mentioned briefly in Scripture. Its origins can be traced to the Bible itself in 2 Chronicles 13:22 and 24:27. Some scholars view certain stories in the Tanak as midrash, such as that of Jonah. See “Tanak”.\r\rFurther Reference:\rNew World Encyclopedia, “Midrash”\rhttp://tinyurl.com/ozpjrxo\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Myth",
                           @"twitterDef":@"a story that cannot be historically verified which contains a profound theological truth",
                           @"definition":@"\rMyths may express truths that are not subject to historical verification. The Primeval History contained in Genesis 1-11 is widely regarded as myth that communicates theological truth about the Creator and the created order, the effects of sin, and the Divine quest for reunion with humanity. See “Primeval History“.\r\rFurther Reference:\rPontifical Biblical Commission\r“The Interpretation of the Bible in the Church”\rhttp://tinyurl.com/nmj6amr\r\rWikipedia, “Creation Myth”\rhttp://tinyurl.com/33adt4\r\r\r",
                           @"category":@"Biblical"}];
    ...
    */
    ...
    [TAWord wordWithDict:@{@"name":@"Patriarch",
                           @"twitterDef":@"the male founder & leader of a family",
                           @"definition":@"\rThe stories of the patriarchs figure prominently in the Old Testament as the founding fathers of the Israelite nation. Scripture portrays Abraham, Isaac, and Jacob as 3 generations of Hebrew patriarchs. The Abraham and Jacob material receive the most attention, while Isaac seesms to be a transitional figure. In the New Testament, St. Paul claims that the faith of Abraham is symbolic of both the faith of Jesus and that of his believers.\r\rFurther Reference:\rCatechism of the Catholic Church, 59\rhttp://tinyurl.com/k6ljesq\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Papacy",
                           @"twitterDef":@"the office of the Pope, the Bishop of Rome",
                           @"definition":@"\rThe Papacy is rooted in two traditions from the early Church. The first is most clearly expressed in the gospel of Matthew, that Jesus chose Simon the fisherman to be the leader and center of unity among the Apostles. In light of this function, Jesus renamed him “Peter”, meaning “rock”. The second is found the martyrdom of Peter and Paul in Rome. In his explanation of its significance for the whole Church, Irenaeus of Lyon cites the dual-apostolic foundation of Rome as a sure measure of apostolicity and catholicity:\r\r“Since, however, it would be very tedious, in such a volume as this, to reckon up the successions of all the Churches, we do put to confusion all those who, in whatever manner, whether by an evil self-pleasing, by vainglory, or by blindness and perverse opinion, assemble in unauthorized meetings; [we do this, I say,] by indicating that tradition derived from the apostles, of the very great, the very ancient, and universally known Church founded and organized at Rome by the two most glorious apostles, Peter and Paul; as also [by pointing out] the faith preached to men, which comes down to our time by means of the successions of the bishops. For it is a matter of necessity that every Church should agree with this Church, on account of its pre-eminent authority,3313 that is, the faithful everywhere, inasmuch as the apostolical tradition has been preserved continuously by those who exist everywhere.”\r-Irenaeus, III.3\r\rSee “Petrine Ministry”.\r\rFurther Reference:\rCatechism of the Catholic Church, 880\rhttp://tinyurl.com/m65ttaf\r\rIrenaeus of Lyon, “Against Heresies”\rhttp://tinyurl.com/h8vovlp\r\rFr. J. Tillard\r“The Jurisdiction of the Bishop of Rome”\rhttp://tinyurl.com/jptdjlv\r\r\r",
                           @"category":@"Systematic"}]; 
    ...
    [TAWord wordWithDict:@{@"name":@"Primeval History",
                           ...
                           @"definition":@"\rThe Primeval History has a different literary quality than the later chapters of Genesis which are associated with known historical locations. These chapters are set before the beginnings of the Israelite nation and contain the creation and flood accounts from the Yahwhist and Priestly authors as well as a Yawhist narrative about the Tower of Babel. Genesis 1-11 is composed mostly of the Yahwist and Priestly Sources with additions from the final Redactor.\r\rFurther Reference:\rWikipedia, “Book of Genesis”\rhttp://tinyurl.com/2yeugf\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Prophetic Books",
                           @"twitterDef":@"the fifth of five sections of the Old Testament that contain the oracles of the prophets",
    ...
    [TAWord wordWithDict:@{@"name":@"Physicalism",
                           ...
                           @"definition":@"\rPhysicalism is offered as an alternative to traditional Dualism and has received from support from modern neuroscience. Various Christian philosophers, such as Nancey Murphy, are advocates of a non-reductive, physicalist anthropology. See “Dualism”.\r\rFurther Reference:\rNancey Murphy\r“Is Non-Reductive Physicalism an Oxymoron?”\rhttp://tinyurl.com/po8oo85\r\r\r",
                           @"category":@"Cultural"}];
    ...
    [TAWord wordWithDict:@{@"name":@"RCIA",
                           @"twitterDef":@"Rite of Christian Initiation of Adults",
                           @"definition":@"\rRCIA was developed after the Second Vatican Council by the U.S. Bishops for local parishes in the United States to help foster catechesis for adults who are seeking to enter full communion with the Church. See “Catechesis”.\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Religion",
                           @"twitterDef": @"an authoritative spiritual tradition that determines beliefs, community life, and lifestyle",
                           @"definition":@"\rReligion has developed along with other human institutions. Early religions were polytheistic. The ancient Israelites practiced henotheism, and monotheism eventually emerged in Israel after the Exile. In ancient Rome, religion was considered reverence for the gods which guaranteed the security of the state. Not all religions include a god or gods as objects of worship (e.g. Buddhism). See “Worldview”.\r\rLatin, (religare) “to reconnect”\r\rFurther Reference:\rWikipedia, “Religion”\rhttp://tinyurl.com/kyolw5y\r\r\r",
                           @"category":@"Cultural"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Relativism",
                           @"twitterDef":@"the belief that there are no universal truths;\ra hermeneutical method that uses no criterion for interpretation",
                           @"definition":@"\rAs a worldview, relativism can be traced to various thinkers in the ancient Greek philosophical tradition. Modern relativism often takes the form of moral relativism. Before his electction to the Papacy, Cardinal Joseph Ratzinger emphasized the dangers of such a worldview:\r\r“Today, having a clear faith based on the Creed of the Church is often labeled as fundamentalism. Whereas relativism, that is, letting oneself be 'tossed here and there, carried about by every wind of doctrine', seems the only attitude that can cope with modern times. We are building a dictatorship of relativism that does not recognize anything as definitive and whose ultimate goal consists solely of one's own ego and desires.”\r-Papal Homily\r\rAs a hermeneutical method, relativism believes that the correspondance between the text and its meaning is infinite, with no limits on interpretation. Along with fundamentalims, it uses no criterion to interpret the text; it neglects the intellectual obligaiton of proper exegesis before attempting interpretation. See “Hermeneutics”, “Philosophy”, “Logic”.\r\rFurther Reference:\rCardinal Joseph Ratzinger\r“Papal Homily, 4.18.2005”\rhttp://tinyurl.com/7nlhk\r\r\r",
                           @"category":@"Cultural"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Resurrection",
                           ...
                           @"definition":@"\rWhile early Hebrew theology did not include an afterlife, the belief in resurrection developed in post-Exilic Judaism, in part, as an answer the question of the continued misfortune of the Covenant-faithful Israelites. The early Christians believed that Jesus of Nazareth was raised from the dead and thus, demonstrated to be the Messiah and Lord. In the New Testament, resurrection should not be understood merely as resuscitation of a physical body, nor should it be understood as the immortality of a soul freed of the confines of the body. Resurrection is, rather, the entry into God's own eternal life.\r\rIn the Gospel of John, Thomas is portrayed as having difficulty in connecting the experience of the resurrection of Jesus with the tragedy of his crucifixion. Fr. David Norman observes:\r\r“Thomas doubted the truth conveyed by the cross and the resurrection. If he had not been so importunate, then his faith truly could have been counted as folly. Though it would appear that Thomas insists on proof, that he see, the object of his doubt cannot be the truth of the appearing of God to the ten; he doubts that the theophany has Jesus of Nazareth as its subject. Thomas refuses to believe until he can certify that the appearing one is the one who was crucified. The evidence for belief in a crucified Lord is insufficient if it is merely a question of the appearing of the Glorified and Exalted One. For Thomas to change his Jewish concept of God — to believe that the crucified Jesus of Nazareth is one with the God of Israel — he needs to 'see,' to verify that the Glorified One is the Crucified One. To give him his credit, he would have garnered the moniker 'gullible' if he had demanded anything less. Instead, his intellectual honesty earned him the misnomer 'doubter'.”\r-Norman, 810\r\rSt. Paul claims that the resurrection of Jesus was the “firstfruits” of the general resurrection that inaugurated the eschaton. Pierre Teilhard de Chardin interpreted the Resurrection as a pre-figuring of the endpoint of human evolution, which he termed the “Omega Point”. See “Crucifixion”, “Second Temple Judaism”, “Jesus of Nazareth”.\r\rFurther Reference:\rCatechism of the Catholic Church, 638-655\rhttp://tinyurl.com/nrt2f6g\r\rRev. David Norman\r“Doubt and the Resurrection of Jesus”\rhttp://tinyurl.com/q5kt2uh\r\rFelix Just, S.J.\r“The Resurrection of Jesus in the New Testament”\rhttp://tinyurl.com/zvebnj9\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Sabbath",
                           @"twitterDef":@"the seventh day of the Hebrew week;\rthe day of rest",
                           @"definition":@"\rThe observance of the Sabbath is commanded in the Decalogue. In Exodus 20, the reason for Sabbath observance is God's cessation from creation, while in Deuteronomy 5, it is the fomer status of slavery in Egypt. Violation of the Sabbath observance was punishable by death and exommunication from the people of Israel whose observance was a sign of their covenant with Yahweh. According to the teaching of the Church, the observance of the Sunday celebration of the Eucharist fulfills the essence of the Sabbath. See “Decalogue”, “Eucharist”, “Yahweh”.\r\rFurther Reference:\rCatechism of the Catholic Church, 2169-2170\rhttp://tinyurl.com/kauvgsv\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Saga",
                           @"twitterDef":@"a myth about a foundational community member that involves trial and triumph",
                           @"definition":@"\rSaga's are a distinct form of myth in that they typically deal with a community's founding memeber's trials and eventual victories over various difficulties via story cycles which are rooted in historical places and events. In the book of Genesis, the three major sagas are of Abraham, Jacob, and Joseph. These stories are intended to encourage the community through its various difficulties.  See “Myth”, “Story Cycle“.\r\rFurther Reference:\rBarry Bandstra, “Reading the Old Testament\rCh. 2: The Ancestral History”\rhttp://tinyurl.com/js7qyax\r\r\r",
                           @"category":@"Biblical"}];
    
    
    [TAWord wordWithDict:@{@"name":@"Salvation",
                           @"twitterDef":@"deliverance from sin and death",
                           @"definition":@"\rSalvation is a theme that runs throughout the Scriptures. Yahweh is referred to as a Savior in the Old Testament, and the New Testament refers to Jesus as the Savior of the world. His is the name by which all must be saved (Acts 4:12). The ancient dictum: Extra Ecclesium Nulla Salus (“Outside the Church there is no salvation.”) has been positively interpreted by the Fathers of the Second Vatican Council as meaning that non-Christians relate to the Church in various ways. The Congregation for the Doctrine of the Faith (CDF) stated in 2000:\r\r“With respect to the way in which the salvific grace of God — which is always given by means of Christ in the Spirit and has a mysterious relationship to the Church — comes to individual non-Christians, the Second Vatican Council limited itself to the statement that God bestows it 'in ways known to himself'. Theologians are seeking to understand this question more fully.  Their work is to be encouraged, since it is certainly useful for understanding better God's salvific plan and the ways in which it is accomplished. However, from what has been stated above about the mediation of Jesus Christ and the 'unique and special relationship' which the Church has with the kingdom of God among men — which in substance is the universal kingdom of Christ the Saviour — it is clear that it would be contrary to the faith to consider the Church as one way of salvation alongside those constituted by the other religions, seen as complementary to the Church or substantially equivalent to her, even if these are said to be converging with the Church toward the eschatological kingdom of God.”\r-CDF, 21\r\rThose who have never experienced the particular grace of the Holy Spirit may nevertheless experience salvation according to the mercy of God, but this does not negate the Church as the public means of salvation. See “Inclusivism”.\r\rFurther Reference:\rCongregation for the Doctrine of the Faith, “Dominus Iesus”\rhttp://tinyurl.com/81n1\r\rRichard Clifford & Khaled Anatolios\rChristian Salvation: “Biblical and Theological Perspectives”\rhttp://tinyurl.com/old3n3a\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Sin",
                           @"twitterDef":@"the choice to rebel against love for God and neighbor",
                           @"definition":@"\rIn the Catholic tradition, sin has been classified as either mortal or venial in terms of its effects. Mortal sin destroys charity for God and neighbor due to a grave offence, but must be committed with full knowledge of the sinful nature of the act and with deliberate consent. Venial sin wounds such charity but does not destroy it. The teaching of the Church acknowledges the power of habit in sin as a mitigating factor in assessing varying degrees of guilt. Original Sin, when referring to the sinful condition of fallen humanity, is termed such only analagously, since it is not derived from personal fault, but from the sin of the first humans. Theologians such as Karl Rahner have attempted to analyze sin from the broader perspective of a “fundamental option”, but Pope John Paul II taught that such an orientation is manifested in particular acts. See “Original Sin”.\r\rFurther Reference:\rCatechism of the Catholic Church, 1849-1876\rhttp://tinyurl.com/on3399l\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Septuagint",
                           ...
                           @"definition":@"\rAccording to legend, the Septuagint was made at the request of Ptolemy II Philadelphius (285-247 B.C.) of 72 Jewish scribes. According to the Babylonian Talmud, each of the 72 translators produced the exact same translation. Philo of Alexandria claims that the number 72 was chosen from selecting 6 scholars from each of the 12 tribes of Israel.\r\rFurther Reference:\rText Critical, “Septuagint”\rhttp://tinyurl.com/ht6tabl\r\rSeptuagint Online\rhttp://tinyurl.com/jy4xe4h\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Story Cycle",
                           @"twitterDef":@"the series of repetative short stories with different details that revolve around a central character",
                           @"definition":@"\rIn the Torah, the Abraham cycles involve his migration to Egypt and his wife/sister Sarah's encounter with Pharoah and Abimelech. The Jacob cycle also involves his migration due to famine, his wives, and Abimelech. See “Torah”.\r\rFurther Reference:\rBarry Bandstra, “Reading the Old Testament: An Introduction to the Hebrew Bible” p. 81\rhttp://tinyurl.com/or2a9s5\r\r\r",
                           @"category":@"Biblical"}];
    ...
    */
    ...
    [TAWord wordWithDict:@{@"name":@"Spirituality",
                           @"twitterDef":@"the conscious process of the integration of one's life toward Ultimate value",
    ...
    [TAWord wordWithDict:@{@"name":@"Theological Anthropology",
                           @"twitterDef":@"a theological account of human nature",
                           @"definition":@"\rThe traditional understanding of human nature in theology has been influenced primarily by dualistic and hylomorphic Greek categories from Plato, Aristotle, respectively. These have been refined by St. Thomas Aquinas and form the anthropological model of much of Catholic teaching. Recent findings in science (including evolution and neuroscience) have challenged the traditional dualistic account. Christian philosophers such a Nancey Murphy argue that a more accurate and scientifically informed account is that of Physicalism. Cardinal Joseph Ratzinger defined humanity as the intellectual capacity to understand the concept of God:\r\r“The clay became man at that moment in which a being for the first time was capable of forming, however dimly, the thought God. The first “thou“ that - however stammeringly - was said by human lips to God marks the moment in which spirit arose in the word. Here the Rubicon of anthropogenesis was crossed.”\r-Ratzinger, 39-40\r\rSee “Physicalism”.\r\rFurther Reference:\rJoseph Ratzinger, “Credo For Today”\rhttp://tinyurl.com/hptk2m8\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Tax Collectors",
                           @"twitterDef":@"Jews who collected provincial taxes for the Roman Empire",
                           @"definition":@"\rBy the 1st century A.D. 'tax collectors' were native assistants of the 'publicani'; Roman citizens who had been contracted by the Empire for the collection of taxes and other forms of administrative maintenance. Tax collectors are frequently referenced in the gospels due to their presence at numerous border crossings throughout Israel. Understandibly, they were reviled by their fellow Jews as traitors, likely cheats, and sinners. According to the synoptic gospels, Jesus included one such person (e.g. Levi/Matthew) in his inner circle of disciples.\r\rGreek, τελώνης (telones) “public contractor”\r\rFurther Reference:\rCatechism of the Catholic Church, 588\rhttp://tinyurl.com/zynfonl\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Tetragrammaton",
                           @"twitterDef":@"a Greek word meaning “four letters” referring to the four-letter name of Israel's God: YHWH",
                           @"definition":@"\rThe Tetragrammaton is rendered in English bibles as “LORD”. See “Yahweh”.\r\rGreek, τετραγράμματον (tetragrammaton)\r\rFurther Reference:\rCatechism of the Catholic Church, 206\rhttp://tinyurl.com/hhcpzp9\r\rWikipedia, “Tetragrammaton”\rhttp://tinyurl.com/7u37s\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Truth-Claim",
                           @"twitterDef":@"a propositional statement about reality",
                           @"definition":@"\rIn philosophy, truth-claims are foundational to logic and are based on the understanding that truth is ultimately objective. In order to deny truth-claims, one must make use of them. See the Philosophy section of the Overview tab; see “Logic”.\r\rFurther Reference:\rWikipedia, “Truth-Claim”\rhttp://tinyurl.com/pa36jxz\r\r\r",
                           @"category":@"Cultural"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Worldview",
                           @"twitterDef":@"a basic set of beliefs about reality",
                           @"definition":@"\rWorldviews are inherent in any system of belief or epistemological commitments. Both theism and atheism are examples of worldviews, as is relativism, determinism, scientific materialism, etc. See “Philosophy”.\r\rFurther Reference:\rWikipedia, “Worldview”\rhttp://tinyurl.com/o7qv75d\r\r\r",
                           @"category":@"Cultural"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Written Tradition",
                           @"twitterDef":@"the transmission of stories and beliefs by text",
                           @"definition":@"\rBefore the writing of any biblical text, their stories were transmitted orally. The book of Deuteronomy dictates that the commandments of the Torah be passed down orally from parents to children. Eventually, written sources were made in order to establish an official record of the beginnings of the Israelite nation (most likely during the Davidic or Solomonic monarchies). Variations on a common story indicate an oral narrative core around which various authors tailored their writing. For example, in the Old Testament there was an oral tradition that circulated about the patriarch Abraham and his covenant with Yahweh. This tradition was retold with different details based on the narrator's audience, as evidenced in its Yahwist, Elohist, and Priestly accounts.\r\rIn the New Testament, the words of Jesus were passed down orally before the composition of any of the 4 gospels, which were occassioned by the destruction of the Temple and consequent delay of the Parousia. Oral traditions that were recorded but not contained in the gospels illustrate the predominance of the oral tradition in 1st century Palestine. The oral commentary on the Torah (Mishnah) is regarded as equally authortative as the written Torah in modern Judaism. See “Mishnah”, “Parousia”, “Oral Tradition”.\r\rFurther Reference:\rPontifical Biblical Commission\r“The Jewish People and their Sacred Scriptures in the Christian Bible”\rhttp://tinyurl.com/mt3e\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Ziggurat",
                           @"twitterDef":@"the ancient Akkadian term for “tower”",
                           @"definition":@"\rThe Ziggurat was a common style of archecture in the ancient world, as evidenced in both Mesapotamia and South America. The story of the Tower of Babel in Genesis 11 is likely based on Ziggurat design. The ancient Sumerian Etemenanki was possibly its etiological inspiration. See “Primeval History”, “Myth”.\r\rFurther Reference:\rWikipedia, “Tower of Babel”\rhttp://tinyurl.com/ol3n53j\r\r\r",
                           @"category":@"Biblical"}];
