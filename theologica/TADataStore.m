...
- (void)buildDictionaryWords
{
    ...
    [TAWord wordWithDict:@{@"name":@"Assyria",
                           ...
                           @"definition":@"\rOne of the numerous Mesopotamian empires in the ancient world which conquered the northern kindgom of Israel in 722 B.C. See “Israel”.\r\rFurther Reference:\rWikipedia, “Assyria”\rhttp://tinyurl.com/2allao\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Anathema",
                           ...
                           @"definition":@"\rOver time, Anathema came to refer to those who were accursed or banished from the community.\r\rGreek, ἀνάθεμα (anathema)\r\rFurther Reference:\rWikipedia, “Anathema”\rhttp://tinyurl.com/ndppmdt\r\r\r",
                           @"category":@"Systematic"}];
    
    [TAWord wordWithDict:@{@"name":@"Angel",
                           @"twitterDef":@"a spiritual being that communicates Divine messages",
                           @"definition":@"\rAngels are found througout the Scriptures, and their existence is affirmed by the Church as a truth of the faith. Post-Exilic Judaism had developed an intricate angeology by the first century. Jesus alludes to the idea that some angels have been assigned responsibility for the care of specific individuals. The Bible mentions different classes of angels, with Cherubim being the highest. See “Divine Revelation”.\r\rGreek, ἄγγελος (angelos) “messenger”\r\rFurther Reference:\r327\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Agnostic",
                           ...
                           @"definition":@"\rAgnostics are sometimes mistakenly confused with atheists.\r\rFurther Reference:\rCatechism of the Catholic Church, 2127\rhttp://tinyurl.com/lu75a9k.\r\r\r",
                           @"category":@"Cultural"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Atheism",
                           ...
                           @"definition":@"\rAtheism is not a necessary worldview consequent to science.\r\rFurther Reference:\rCatechism of the Catholic Church, 2113\rhttp://tinyurl.com/lu75a9k\r\r\r",
                           @"category":@"Cultural"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Apostolic Fathers",
                           ...
                           @"definition":@"\rThe Aposotolic Fathers are the earliest extra-biblical texts outside the Bible. See “Church Fathers” on the Sources page of the Home tab.\r\rFurther Reference:\rWikipedia, “Apostolic Fathers”\rhttp://tinyurl.com/56xymr\r\r\r",
                           @"category":@"Historical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Beatific Vision",
                           ...
                           @"definition":@"\rAccording to the Gospel of Matthew, those who are pure of heart will see God.\r\rFurther Reference:\rCatechism of the Catholic Church, 1028\rhttp://tinyurl.com/k3f2f8p\r\r\r",
                           @"category":@"Systematic"}];
    
    [TAWord wordWithDict:@{@"name":@"Beatitudes",
                           @"twitterDef":@"sayings in the Sermon on the Mount that begin with the word “Blessed”",
                           @"definition":@"\rThe Beatitudes are likely the most famous of Jesus' sayings from the Sermon on the Mount. They have been described as a compendium of Christian living.\r\rFurther Reference:\rCatechism of the Catholic Church, 1716\rhttp://tinyurl.com/nprr772\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Benediction",
                           ...
                           @"definition":@"\rThe Benediction is a liturgical inheritance of the Church from Judaism. It concludes the Mass with a blessing and a sending forth in peace.\r\rFurther Reference:\rWikipedia, “Benediction”\rhttp://tinyurl.com/bvdxj54\r\r\r",
                           @"category":@"Liturgical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Benefit/Burden Ratio",
                           ...
                           @"definition":@"\rThe Benefit/Burden Ratio is a variable in morality of certain medical procedures. It's use extends outside theology to the broader study of ethics.\r\rFurther Reference:\rNational Catholic Bioethics Center, “A Catholic Guide to End-Of-Life Decisions”\rhttp://tinyurl.com/nmko5uq\r\r\r",
                           @"category":@"Moral"}];
    
    [TAWord wordWithDict:@{@"name":@"Bioethics",
                           @"twitterDef":@"the study of ethics related to medical and life issues",
                           @"definition":@"\rBioethics has become a specialization in the field of ethics due, in part, to the tremendous technological advances that enable new forms of treatment but that also raise new ethical questions in the practice of medicine.\r\rFurther Reference:\rAmerican Bioethics Advisory Commission, “What is Bioethics?”\rhttp://tinyurl.com/k8sppee\r\r\r",
                           @"category":@"Moral"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Biblical Novellas",
                           ...
                           @"definition":@"\rNovellas in the Old Testament include short stories that encourage the Israelites during times of persecution. Though it is included in the book of Genesis, the story of Joseph is recognized as being a Novella. Theses stories are likely contain embelishments of historical events.\r\rFurther Reference:\rUnited States Conference of Catholic Bishops, “Biblical Novellas”\rhttp://tinyurl.com/nnqtv7b\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Blessing",
                           ...
                           @"definition":@"\rThe concept of blessing has its origins in the Old Testament.\r\rHebrew, בְּרָכָה (berakah) “blessing”\r\rFurther Reference:\rCatechism of the Catholic Church, 2626\rhttp://tinyurl.com/jwoavzg\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Ban",
                           ...
                           @"definition":@"\rWhen victorious over its enemies, Israel was to place certain possessions, including people, under the Ban and completely destroy them in order to devote them anew to YHWH. Such is the case in Joshua 6 and 1 Samuel 15, which explicity command the death of women and children. See “YHWH”.\r\rHebrew, חֶרֶם (herem) “cursed”\r\rFurther Reference:\rWikipedia, “Ban”\rhttp://tinyurl.com/p7phypo\r\r\r",
                           @"category":@"Biblical"}];
    
    [TAWord wordWithDict:@{@"name":@"Big Bang Theory",
                           @"twitterDef":@"the theory that the Universe expanded from an infinite singularity",
                           @"definition":@"\rThe cosmological theory, first developed by Fr. George Lemaitre, that claims that the Universe began at an infintely small and dense point of matter, energy, space, and time which then expanded over the course of time to become the observable cosmos we see today. See “Creation”.\r\rFurther Reference:\rWikipedia, “Big Bang”\rhttp://tinyurl.com/9nq4k\r\r\r",
                           @"category":@"Cultural"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Blessed Virgin Mary",
                           ...
                           @"definition":@"\rThe title Blessed Virgin Mary is based, in part, on the prediction of Mary in the Gospel of Luke 1:46: “From now on, all generations will call me blessed”.\r\rFurther Reference:\rCatechism of the Catholic Church, 971\rhttp://tinyurl.com/mtfzewa\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Cantor",
                           ...
                           @"definition":@"\rCantors are an inheritance of the Church from Judaism. In conjuction with the Choir, they are responsible for leading the congregation in the singing of various responses in the Liturgy.\r\rFurther Reference:\rWikipedia, “Cantor”\rhttp://tinyurl.com/odpa6w8\r\r\r",
                           @"category":@"Liturgical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Catechist",
                           ...
                           @"definition":@"\rCatechist are usually those who teach in religious education programs, but the title applies especially to Bishops, whose function it is to teach the Faith.\r\rFurther Reference:\rCongregation for the Clergy, “General Directory on Catechesis”\rhttp://tinyurl.com/tgju\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Censer",
                           ...
                           @"definition":@"Censers are not unique to Catholicism, but rather are used throughout every major, global religious tradition. In Catholicism, they hold the burning incense which symbolizes the prayers of the congregation ascending to God; also called a “Thurible”.\r\rFurther Reference:\rWikipedia, “Censer”\rhttp://tinyurl.com/p4c7brx\r\r\r",
                           @"category":@"Liturgical"}];
    
    [TAWord wordWithDict:@{@"name":@"Casuistic Law",
                           @"twitterDef":@"a type of law derived from individual cases rather than universal norms",
                           @"definition":@"\rCasuistic law is contrasted with apodictic law. The latter is exemplified by the 10 Commandments, while the former is found in the Covenant Code of Exodus 21-23. See “Apodictic Law”.\r\rFurther Reference:\rWikipedia, “Casuistry”\rhttp://tinyurl.com/2pntmh\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"College of Bishops",
                           ...
                           @"definition":@"\rThe College of Bishops is a concept emphasized by Vatican II. See “Apostle”.\r\rFurther Reference:\rCatechism of the Catholic Church, 880-887 http://tinyurl.com/m65ttaf\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Confirmation",
                           ...
                           @"definition":@"\rThe sacrament of reception of the Holy Spirit in which the grace of Baptism is strengthened.\r\rFurther Reference:\rCatechism of the Catholic Church, 1285\rhttp://tinyurl.com/lcgw5p7\r\r\r",
                           @"category":@"Liturgical"}];
    
    [TAWord wordWithDict:@{@"name":@"Conversion",
                           @"twitterDef":@"the process of spiritual transformation",
                           @"definition":@"\rThe process of changing one's direction in life.\r\rFurther Reference:\rCatechism of the Catholic Church, 1989\rhttp://tinyurl.com/yaua7cc\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Cosmological Argument",
                           ...
                           @"definition":@"\rOne of the classical arguments for the existence of God, based on the First Cause argument. See “Big Bang Theory”\r\rFurther Reference:\rSee Stanford Encyclopedia of Philosophy, “Cosmological Argument”\rhttp://tinyurl.com/8xkm72n\r\rThomas Aquinas, Summa Theologica, ST,Ia,q.2a.3co.\rhttp://tinyurl.com/my5bedq\r\r\r",
                           @"category":@"Systematic"}];
    
    [TAWord wordWithDict:@{@"name":@"Contemplation",
                           @"twitterDef":@"a form of silent and meditative prayer",
                           @"definition":@"\rThis form of prayer is mystical in that it is a gaze of faith that enables a more intense communion with the Trinity. See “Trinity”.\r\rFurther Reference:\rCatechism of the Catholic Church, 2709\rhttp://tinyurl.com/n937nqh\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Cherubim",
                           ...
                           @"definition":@"\rCherubim (plural of “cherub”) are found from as early as Genesis 3, where one guards the Tree of Life. They also feature prominently in some prophetic and apocalyptic literature.\r\rFurther Reference:\rWikipedia, “Cherub”\rhttp://tinyurl.com/3llehen\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Creation",
                           ...
                           @"definition":@"\rThe universe.\r\rFurther Reference:\rCatechism of the Catholic Church, 280\rhttp://tinyurl.com/6kvj6\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Call Narrative",
                           ...
                           @"definition":@"\rCall Narratives consist of three parts: call, concern, commission. The stories of Moses, Jeremiah, and Isaiah all involve a call narrative.\r\rFurther Reference:\r\r\r",
                           @"category":@"Biblical"}];
    
    [TAWord wordWithDict:@{@"name":@"Charism",
                           @"twitterDef":@"a spiritual gift that results from the experience of the Holy Spirit",
                           @"definition":@"\rAccording to the Apostle Paul, spiritual gifts accompany the Christian experience of the Holy Spirit. See 1 Corinthians 12.\r\rGreek, χαρίσμa (charisma) “gifts”.\r\rFurther Reference:\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Codex",
                           ...
                           @"definition":@"\rVarious codices make up the biblical manuscript tradition. See “Manuscript”.\r\rFurther Reference:\rCodex Sinaiticus\rhttp://tinyurl.com/5fg98l\r\r\r",
                           @"category":@"Biblical"}];
    ...
    */
    ...
    [TAWord wordWithDict:@{@"name":@"Deism",
                           ...
                           @"definition":@"\rDeism became popular during the Enlightenment and rise of science primarily in Europe during the 16th and 17th centuries. It is most famously displayed in the works of Voltaire. See “Creation”.\r\rFurther Reference:\rWikipedia, “Deism”\rhttp://tinyurl.com/oc6xh\r\r\r",
                           @"category":@"Cultural"}];
    
    [TAWord wordWithDict:@{@"name":@"Determinism",
                           @"twitterDef":@"the belief that all events are determined by physical phenomena",
                           @"definition":@"\rThe belief that all events, including human actions, are determined by physical phenomena, negating the concept of free-will. See “Free Will”.\r\rFurther Reference:\rStanford Encyclopedia of Philosophy, “Causal Determinism”\rhttp://tinyurl.com/ew8c\r\r\r",
                           @"category":@"Cultural"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Development",
                           ...
                           @"definition":@"\rHuman development is a central theme in Catholic Social Teaching as it applies to the Life and Dignity of the Human Person. It has been measured by the United Nations since 1990 with the first Human Development Report. See “Dignity of the Human Person”, “Catholic Social Teaching”.\r\rFurther Reference:\rUnited Nations Development Programme\rhttp://tinyurl.com/khsqbzk\r\r\r",
                           @"category":@"Cultural"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Ecumenism",
                           ...
                           @"definition":@"\rA movement which gained popularity in the 20th century that emphasized shared beliefs among various Christian churches over and against differences.\r\rFurther Reference:\rVatican II, “Unitatis Redintegratio”\rhttp://tinyurl.com/3xnyh\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Ex Cathedra",
                           ...
                           @"definition":@"\rWhen the Pope explicitly teaches from the chair (ex cathedra) of Peter, his teaching is considered infallible.\r\rFurther Reference:\rWikipedia, “Papal Infallibility”\rhttp://tinyurl.com/ntrobem\r\r\r",
                           @"category":@"Systematic"}];
    
    [TAWord wordWithDict:@{@"name":@"Ex Nihilo",
                           @"twitterDef":@"the act of God creating from nothing",
                           @"definition":@"\rThe phrase ex nihilo is used to express the belief that God created the Universe out of nothing.\r\rLatin (ex nihilo) “from nothing”\r\rFurther Reference:\rCatechism of the Catholic Church, 296\rhttp://tinyurl.com/6kvj6\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Ex Opere Operantis",
                           ...
                           @"definition":@"\rThis phrase refers to the emphasis on the subjective character of the celebrant. In the Catholic tradition, it does not affect the validity of the Sacraments. a Latin phrase meaning\rfrom the work of the worker....See Ex Opere Operato.\r\rFurther Reference:\r\r\r",
                           @"category":@"Systematic"}];
   ...
   //////////////////////////////////////////F
    ...
    [TAWord wordWithDict:@{@"name":@"Glossolalia",
                           ...
                           @"definition":@"\rAccording to Paul in 1 Corinthians 14, glossolalia was a spiritual gift manifested in liturgical worship. While not denying its validity, he encouraged a disciplined practice only if accompanied by a translation.\r\rFurther Reference:\rWikipedia, “Glossolalia”\rhttp://tinyurl.com/c2f7g\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Gregorian Chant",
                           ...
                           @"definition":@"\rGregorian Chant is characterized by a simple rhythm. The bishops of Vatican II taught that it should be given priority in liturgical services.\r\rFurther Reference:\rVatican II, “Sacrosanctum Concilium”, 116\rhttp://tinyurl.com/ay8y\r\r\r",
                           @"category":@"Liturgical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Historical Theology",
                           ...
                           @"definition":@"\rOver the last 100 years, Historical Theology has become a sub-discipline of Theology. It is usually divided into various periods in Church history:\r\rPatristic\rMedieval\rByzantine\rReformation\rModern\r\rFurther Reference:\rHistorical Theology Online\rhttp://tinyurl.com/pdverjl\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Host",
                           ...
                           @"definition":@"\rThe Host is made of unleavened bread in the Western liturgical tradtion, while the East has historically used leavened bread. It is placed on a Paten when on the Altar. See “Altar”, “Eucharist”, “Paten”.\r\rFurther Reference:\rWikipedia, “Sacramental Bread”\rhttp://tinyurl.com/lho5vze\r\r\r",
                           @"category":@"Liturgical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Infallibility",
                           ...
                           @"definition":@"\rInfallibility is exercised in three ways:\r\r-by the consent of the Faithful\r-by the Bishops together with the Pope\r-by the Pope ex cathedra\r\rFurther Reference:\rWikipedia, “Infallibility of the Church”\rhttp://tinyurl.com/n58unch\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Invitatory Psalm",
                           ...
                           @"definition":@"\rThe Invitatory Psalm usually has the theme of praise to God for the newness of the day. It is often said as an antiphon. See “Antiphon”, “Morning Prayer”, “Office of Readings”.\r\rFurther Reference:\rWikipedia, “Invitatory”\rhttp://tinyurl.com/lvw8sht\r\r\r",
                           @"category":@"Liturgical"}];


    [TAWord wordWithDict:@{@"name":@"Impediment",
                           @"twitterDef":@"a hiderance to human freedom;\ractual or habitual",
                           @"definition":@"\rActual impediments are those found in the situation of the subject. Virtual impediments are those found within the character of the subject.\r\rFurther Reference:\rJames P. Hannigan, “As I Have Loved You: The Challenge of Christian Ethics”, 54-55 http://tinyurl.com/npm2vvg\r\r\r",
                           @"category":@"Moral"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Idolatry",
                           ...
                           @"definition":@"\rThe post-Exilic Hebrew prophets repeatedly condemn the worship of other gods by the Israelites as idolatry. Pope Francis has repeatedly condemned the idolatry of money, prevalent in wealthy nations. See “Exile”.\r\rFurther Reference:\rCatechism of the Catholic Church, 2113\rhttp://tinyurl.com/lu75a9k\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Justification",
                           ...
                           @"definition":@"\rSt. Paul uses this legal term in his letter to the Romans to describe those who have faith in Jesus Christ (or the faith of Jesus Christ).\r\rFurther Reference:\rCatechism of the Catholic Church, 1990\rhttp://tinyurl.com/yaua7cc\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Jus Ad Bellum",
                           ...
                           @"definition":@"\rJus Ad Bellum criteria include: just cause, comparative justice, competent authority, right intention, probability of success, last resort, proportionality. See “Just War Theory”.\r\rLatin, (jus ad bellum) “justice to war”\r\rFurther Reference:\rStanford Encyclopedia of Philosophy, “War” http://tinyurl.com/84c2ppg\r\r\r",
                           @"category":@"Moral"}];
    
    [TAWord wordWithDict:@{@"name":@"Jus Im Bello",
                           @"twitterDef":@"a set of criteria used to determine if the methods of war are justified",
                           @"definition":@"\rJus Im Bello criteria include: distinction, proportionality, military necessity. See “Just War Theory”.\r\rLatin, (jus im bello) “justice in war”\r\rFurther Reference:\rStanford Encyclopedia of Philosophy, “War” http://tinyurl.com/84c2ppg\r\r\r",
                           @"category":@"Moral"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Just War Theory",
                           ...
                           @"definition":@"\rThe theory first developed by Augustine and later refined by Aquinas which consists of criteria for determining the justice of both the conditions and methods of war. See “Jus Ad Bellum”, “Jus Im Bello”.\r\rFurther Reference:\rCatechism of the Catholic Church, 2309\rhttp://tinyurl.com/dh7r\r\rStanford Encyclopedia of Philosophy, “War” http://tinyurl.com/84c2ppg\r\r\r",
                           @"category":@"Moral"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Kataphatic",
                           ...
                           @"definition":@"\rKataphatic theology emphasizes the idea that God can be known through Divine Revelation. See “Divine Revelation”.\r\rFurther Reference:\rWikipedia, “Kataphatic”\rhttp://tinyurl.com/lghxwjd\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Kosher",
                           ...
                           @"definition":@"\rThe classification of some foods as “kosher” is unique to the Priestly Source. Leviticus 11 gives a detailed list of foods that are considered by the P author to be unclean. See “Priestly Source”.\r\rFurther Reference:\rWikipedia, “Kosher Foods”\rhttp://tinyurl.com/druwv\r\r\r",
                           @"category":@"Biblical"}];
    
    [TAWord wordWithDict:@{@"name":@"Kerygma",
                           @"twitterDef":@"a Greek word meaning “proclamation”;\rthe proclamation of the Gospel",
                           @"definition":@"\rThe New Testament uses this word to describe both the proclamation of Jesus himself about the good news of the Kingdom as well as the Apostolic proclamation about his death and resurrection. See “Gospel”.\r\rGreek, κήρυγμα (kerygma)\r\rFurther Reference:\rWikipedia, “Kerygma”\rhttp://tinyurl.com/llks24m\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Last Rites",
                           ...
                           @"definition":@"\rLast Rites are the last Sacraments given in preparation for the final journey of the believer into eternal life. See “Sacrament”.\r\rFurther Reference:\rCatechism of the Catholic Church, 1524-1525 http://tinyurl.com/n3lyve9\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Laity",
                           ...
                           @"definition":@"\rThe Laity are called to share in the kingly, prophetic, and priestly office of Christ. They manifest the “sensus fidei” (sense of the faith), which has at times, according to Cardinal John Henry Newman, preserved the faith of the Church and prevented the Magisterium from teaching error. See “Three-fold Ministry”, “Sensus Fidelium”.\r\rFurther Reference:\rCatechism of the Catholic Church, 897\rhttp://tinyurl.com/m65ttaf\r\r\r",
                           @"category":@"Systematic"}];
    
    [TAWord wordWithDict:@{@"name":@"Latria",
                           @"twitterDef":@"a Greek word meaning “worship of God”",
                           @"definition":@"\rIn contrast to Dulia (veneration) given to creation, latria refers to worship of God alone. See “Dulia”.\r\rFurther Reference:\rWikipedia, “Latria”\rhttp://tinyurl.com/mv9sqf\r\r\r",
                           @"category":@"Liturgical"}];
    
    [TAWord wordWithDict:@{@"name":@"Law of Moses",
                           @"twitterDef":@"the first five books of the Pentateuch",
                           @"definition":@"\rThe phrase “Law of Moses” is referred to in many places in the Hebrew Bible as a single scroll. Deuteronomy in particular presents itself as the “Law/Teaching of Moses“. The single word “Law” (Torah) is used as a shorthand for the entire Torah in the New Testament. The Law contains various commandments and regulations regarding morality and community life for the Israelites. See “Torah”, “Pentateuch”.\r\rHebrew, תֹּורַת מֹשֶׁה (torat moshe) “Law of Moses”\r\rFurther Reference:\rWikipedia, “Law of Moses”\rhttp://tinyurl.com/cgyff\r\r\r",
                           @"category":@"Biblical"}];
    
    [TAWord wordWithDict:@{@"name":@"Lector",
                           @"twitterDef":@"a member of the laity who leads the congretation in reading or prayers",
                           @"definition":@"\rThe ministry of Lector is a service in the Liturgy through the reading of the Scriptures and and the Prayer of the Faithful. It is open to qualified members of the Laity. See “Prayer of the Faithful”, “Laity”.\r\rFurther Reference:\rCatechism of the Catholic Church, 903\rhttp://tinyurl.com/m65ttaf\r\r\r",
                           @"category":@"Liturgical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Lex Orandi, Lex Credendi",
                           ...
                           @"definition":@"\rThis idea makes the connection between belief and practice explicit.\r\rLatin, (lex orandi, lex credendi) “law of prayer, law of belief”\r\rFurther Reference:\rCatechism of the Catholic Church, 1124\rhttp://tinyurl.com/cmes38\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Liberation Theology",
                           ...
                           @"definition":@"\rLiberation Theology was developed by Fr. Gustavo Gutierrez in the early 1970's through his major work “A Theology of Liberation”. See “Catholic Social Teaching“, “Social Justice“.\r\rFurther Reference:\rCongregation For The Doctrine Of The Faith, “Instruction On Certain Aspects Of The Theology Of Liberation\rhttp://tinyurl.com/27d23\r\r\r",
                           @"category":@"Systematic"}];
    
    [TAWord wordWithDict:@{@"name":@"Liturgy",
                           @"twitterDef":@"the participation of the Church in the Paschal Mystery",
                           @"definition":@"\rThe Liturgy of the Church is not limited to its public worship. Rather, it includes works of charity as well as the proclamation of the Gospel. It is an “exercise of the priestly office of Jesus Christ”.\r\rFurther Reference:\rCatechism of the Catholic Church, 1069\rhttp://tinyurl.com/opjnz9x\r\r\r",
                           @"category":@"Liturgical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Liturgy of the Word",
                           ...
                           @"definition":@"\rThe Liturgy of the Word, the Church listens to the Word of God from the Scriptures and is exhorted to Christian living in the homily. It concludes with the Prayer of the Faithful. See “Homily”, “Prayer of the Faithful”.\r\rFurther Reference:\rUnited States Conference of Catholic Bishops, “Liturgy of the Word”\rhttp://tinyurl.com/lzxk5e8\r\r\r",
                           @"category":@"Liturgical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Law of Non-Contradiction",
                           ...
                           @"definition":@"\rThis principle is first found in the writings of Aristotle, in his fourth book on Metaphysics. There he claims that without this principle, no learning could be possible.\r\rStanford Encyclopedia of Philosophy, “Aristotle on Non-Contradiction”\rhttp://tinyurl.com/yvzfdk\r\r\r",
                           @"category":@"Cultural"}];
    ...
    [TAWord wordWithDict:@{@"name":@"LORD",
                           ...
                           @"definition":@"\rMost contemporary English bibles render the Divine Name as the LORD to indicate that the underlying Hebrew name of God. See “Tetragrammaton”\r\rFurther Reference:\rWikipedia, Tetragrammaton\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Lumen Gentium",
                           ...
                           @"definition":@"\rLumen Gentium is the most authoritative Church teaching on the nature, structure, and mission of the Church. See “Ecclesiology”, “Church”\r\rLatin (lumen gentium) “light of the nations”\r\rFurther Reference:\rVatican II, “Lumen Gentium” http://tinyurl.com/3wxff\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Marcionism",
                           ...
                           @"definition":@"\rMarcionism led to the creation of the first canon of Scripture during the time of Irenaeus, who identified 4 authentic gospels. See “Canon”.\r\rFurther Reference:\rWikipedia, “Marcionism”\rhttp://tinyurl.com/yo3bp6\r\r\r",
                           @"category":@"Historical"}];
    
    [TAWord wordWithDict:@{@"name":@"Marriage",
                           @"twitterDef":@"the Sacrament in which a man and woman become one flesh",
                           @"definition":@"\rMarriage as human institution has evolved in conjunction with human society. As a Sacrament, Marriage reflects the nuptial identity of the human person and is intrinsically connected to the creation of families. It faces new challenges in the face of the growing numbers of divorce, dysfunctional households, and acceptance of same-sex unions.\r\rFurther Reference:\rCatechism of the Catholic Church, 1601\rhttp://tinyurl.com/ykptlg\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Morality",
                           ...
                           @"definition":@"\rcustomary norms of behavior considered good or evil, right or wrong in a given system.\r\rFurther Reference:\rCatechism of the Catholic Church, 1749-1756 http://tinyurl.com/lxslc7r\r\r\r",
                           @"category":@"Moral"}];
    
    [TAWord wordWithDict:@{@"name":@"Mystery",
                           @"twitterDef":@"that which transcends human comprehension and explanation",
                           @"definition":@"\rIn the Catholic tradition, God is ultimately Mystery and can only be partially known through Divine Revelation. See “Divine Revelation”.\r\rFurther Reference:\rWikipedia, “Absolute”\rhttp://tinyurl.com/q9atwcx\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Ministry",
                           ...
                           @"definition":@"\rMinistry in the Church takes many different forms. The two primary categories are ordained and lay ministry.\r\rFurther Reference:\rCatechism of the Catholic Church, 874\rhttp://tinyurl.com/m65ttaf\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Missal",
                           ...
                           @"definition":@"\rThe 2011 new translation of the Mass was based on the Roman Missal. See “Liturgy”.\r\rFurther Reference:\rCongregation for Divine Worship and Discipline of the Sacraments, “General Instruction on the Roman Missal”\rhttp://tinyurl.com/kmepha\r\r\r",
                           @"category":@"Liturgical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Monasticism",
                           ...
                           @"definition":@"\rMonastics tace their origin to the third century with Abba Anthony of Egypt.\r\rFurther Reference:\rWikipedia, “Monasticism”\rhttp://tinyurl.com/n7kl2y\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Myth",
                           ...
                           @"definition":@"\rMyths may express truths that are not subject to historical verification. The Primeval History contained in Genesis 1-11 is widely regarded as myth that communicates theological truth about the Creator and the created order, the effects of sin, and the Divine quest for reunion with humanity.\r\rFurther Reference:\rWikipedia, “Creation Myth”\rhttp://tinyurl.com/33adt4\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Montanism",
                           ...
                           @"definition":@"\rMontanus taught that the Holy Spirit, promised by Jesus, had incarnated himself in Montanus, who demanded his followers adopt a strict lifestyle...\r\rFurther Reference:\rWikipedia, “Montanism”\rhttp://tinyurl.com/dnms5r\r\r\r",
                           @"category":@"Historical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Morning Prayer",
                           ...
                           @"definition":@"\rMorning Prayer is the beginning of the Divine Office. See “Liturgy of the Hours”.\r\rFurther Reference:\rWikipedia, “Liturgy of the Hours”\rhttp://tinyurl.com/c8tnn5\r\r\r",
                           @"category":@"Liturgical"}];
    
    [TAWord wordWithDict:@{@"name":@"Metaphysics",
                           @"twitterDef":@"the study of the fundamental nature of reality",
                           @"definition":@"\rMetaphysics is a highly contested area of inquiry that has including a variation of topics throughout history since the time of Aristotle. More generally, it is the study of being as such. Theology is a metaphysical discipline insofar as theology makes claims about the fundamental nature of reality, which, in the Catholic Tradition, is known as God.\r\rFurther Reference:\rRoutledge Encyclopedia of Philosophy, “Metaphysics” http://tinyurl.com/mydu3hx\r\r\r",
                           @"category":@"Cultural"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Natural Law",
                           ...
                           @"definition":@"\rThe concept of natural law dates back to the early Greek philosophers. It is alluded to in St. Paul's epistle to the Romans 1:21. It is treated extensively by St. Thomas Aquinas in the Summa Theologica.\r\rFurther Reference:\rCatechism of the Catholic Church, 1954\rhttp://tinyurl.com/yla3tgm\r\r\r",
                           @"category":@"Moral"}];
    
    [TAWord wordWithDict:@{@"name":@"Natural Theology",
                           @"twitterDef":@"the study of God by inference from the facts of the physical world",
                           @"definition":@"\rNatural Theology is the attempt to examine the concept of God from the natural world, apart from any special revelation. See “Divine Revelation”.\r\rFurther Reference:\rInternet Encyclopedia of Philosophy, “Natural Theology”\rhttp://tinyurl.com/7ckb5tz\r\r\r",
                           @"category":@"Systematic"}];
    
    [TAWord wordWithDict:@{@"name":@"Nevi'im",
                           @"twitterDef":@"the Hebrew word meaning “prophets”",
                           @"definition":@"\rThe Nevi'im is the second of the three sections of the Tanak. Isaiah, Jeremiah, and Ezekiel are the major prophets, while others are considered minor prophets, due to the length of their books. See “Tanak”.\r\rHebrew, נְבִיאִים (neviim)\r\rFurther Reference:\rWikipedia, “Nevi'im”\rhttp://tinyurl.com/qyks6kh\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"New Testament",
                           ...
                           @"definition":@"\rThe New Testament contains the 4 gospels, the Acts of the Apostles, numerous epistles, and the Apocalypse. See “Gospel”, “Epistle”, “Apocalypse”.\r\rFurther Reference:\rCatechism of the Catholic Church, 124-127 http://tinyurl.com/kvc3tvq\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Numinous",
                           ...
                           @"definition":@"\rAccording to Rudolf Otto, in his seminal work, “The Idea of the Holy”, religious experience is an encounter with the Holy this is totally Other and numinous. Such experiences are mysteriously terrifying (mysterium tremendum) and mysteriously fascinating (mysterium fascinans).\r\rFurther Reference:\rWikipedia, “Numinous”\rhttp://tinyurl.com/q2nys8u\r\r\r",
                           @"category":@"Systematic"}];
    ...
    */
    ...
    [TAWord wordWithDict:@{@"name":@"Ordinary",
                           ...
                           @"definition":@"\rThe Ordinary is used to distinguish the diocesan bishop from an assistant or coadjutor.\r\rFurther Reference:\r\r\r\r",
                           @"category":@"Systematic"}];
    
    [TAWord wordWithDict:@{@"name":@"Ordinary Time",
                           @"twitterDef":@"the liturgical time between Easter and Advent",
                           @"definition":@"\rOrdinary Time is divided into two segments; from the Baptism of the Lord to Ash Wednesday and from Pentecost to Advent. During the Ordinary Time, the readings in the Lectionary are not chosen topically.\rFurther Reference:\rWikipedia, “Ordinary Time”\rhttp://tinyurl.com/6xzoaj\r\r\r",
                           @"category":@"Liturgical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Original Sin",
                           ...
                           @"definition":@"\rOriginal Sin, while not named as such, is alluded to by St. Paul in Romans 5:12. St. Augustine coined the term in his dispute with the Pelagians. In the traditional teaching of the Church, Original Sin can be understood as both the explanans and explanandum. As explananas it explains the human condition of evil, suffering, and death. As explanandum, it is the human condition which requires explanation.\r\rFurther Reference:\rCatechism of the Catholic Church, Article I, Paragraph 7\rhttp://tinyurl.com/llux3he\r\r\r",
                           @"category":@"Systematic"}];
    
    [TAWord wordWithDict:@{@"name":@"Orthodox",
                           @"twitterDef":@"straight or correct belief",
                           @"definition":@"\r\r\rFurther Reference:\r\r\r",
                           @"category":@"Systematic"}];
    
    [TAWord wordWithDict:@{@"name":@"Orthopraxis",
                           @"twitterDef":@"straight or correct practice",
                           @"definition":@"\ra Greek word meaning 'straight practice.\r\rFurther Reference:\r\r\r",
                           @"category":@"Systematic"}];
    
    [TAWord wordWithDict:@{@"name":@"Old Testament",
                           @"twitterDef":@"the 46 books dealing with the people of Israel",
                           @"definition":@"\rThe books of the Old Testament are grouped into five categories:\r\r-rPentateuch\r-Historical Books\r-Biblical Novellas\r-Wisdom Books\r-Prophetic Books\r\rThe Church teaches that the Old Testament prefigures the life of Christ through Typology. The Old Testament is based on the Hebrew Bible, which only includes 39 books. See “Tanak”, “Typology”.\r\rFurther Reference:\rWikipedia, “Old Testament”\rhttp://tinyurl.com/fvz4q\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Panentheism",
                           ...
                           @"definition":@"\rPanentheism is examplified in Acts 17:28 in which St. Paul claims that God gives everything life; “in him we live, move, and have our being”. Both modern theologians and philosophers have claimed a panentheistic model of the God-World relationship. According to Alfred North Whitehead, in a panentheistic worldview, God has both necessary and contigent properties. See “Process Theology”.\r\rFurther Reference:\rStanford Encyclopedia of Philosophy, “Panentheism” http://tinyurl.com/5e8c62\r\r\r",
                           @"category":@"Systematic"}];
    
    [TAWord wordWithDict:@{@"name":@"Parousia",
                           @"twitterDef":@"a Greek word meaning “presence”;\rthe presence of the glorified Christ",
                           @"definition":@"\rParousia is a term used by St. Paul in the New Testament to refer to the second coming of Christ.\r\rGreek, παρουσία (parousia)\r\rFurther Reference:\rWikipedia, “Parousia”\rhttp://tinyurl.com/6rwp6r\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Patristics",
                           ...
                           @"definition":@"\rPatristics is essential for the study of theology. The period of the Church Fathers usually extends from the sub-Apostolic Age to the 8th century, ending with the 7th Ecumenical Council at Nicea and the life of St. John of Damascus.\r\rFurther Reference:\rWikipedia, “Patristics”\rhttp://tinyurl.com/qy8fxhj\r\r\r",
                           @"category":@"Historical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Palm Sunday",
                           ...
                           @"definition":@"\rAccording to Letter XX of St. Ambrose of Milan, Palm Sunday was the day on which the Creed was taught to Catechumens. The current practice of congregants waving palm branches dates to the 9th century in France.\r\rFurther Reference:\rWikipedia, “Palm Sunday”\rhttp://tinyurl.com/owdpgsc\r\r\r",
                           @"category":@"Liturgical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Passover",
                           ...
                           @"definition":@"\rThe Passover is found in both the Yahwist and Priestly sources. It apparently fell into disuse by the time of Hezekiah, who reinstituted it around 700 B.C. It nevertheless waned in importance until the time of Josiah, who also reinstituted Passover. Jesus of Nazareth was crucified by Pontius Pilate during Passover, likely around A.D. 30.\r\rFurther Reference:\rWikipedia, “Passover”\rhttp://tinyurl.com/pol8o\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Pericope",
                           @"twitterDef":@"a smaller section of a larger text",
                           @"definition":@"\rPericopes are sections of a larget text that form coherent, self-contained units. They are most frequently referred to in the context of the Gospels.\r\rGreek, περικοπή (pericope) “a cutting around”\r\rFurther Reference:\rWikipedia, “Pericope”\rhttp://tinyurl.com/ptoqwnn\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Pharisees",
                           ...
                           @"definition":@"\rThe Pharisees are portrayed as the opponents of Jesus in the Synoptic Gospels. The book of Acts reports that many Pharisees became members of the nacent Christian community. See “Synoptic Gospels”.\r\rFurther Reference:\rWikipedia, “Pharisees”\rhttp://tinyurl.com/5kgenf\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Prophet",
                           ...
                           @"definition":@"\rThis term is used in the Old Testament to refer to either a court prophet (such as Nathan) or an independent prophet (such as Amos).\r\rFurther Reference:\rFelix Just, S.J., “What is Biblical Prophecy?” http://tinyurl.com/82n9ezg\r\r\r",
                           @"category":@"Biblical"}];
    
    [TAWord wordWithDict:@{@"name":@"Prophetic Books",
                           @"twitterDef":@"the fifth of five sections of the Old Testament",
                           @"definition":@"\rThe Prophetic Books are usually divided into the categories of Major and Minor, based on the length of the book. Isaiah, Jeremiah, and Ezekiel are the major prophetic books, while the remaining books are considered minor.\r\rFurther Reference:\rUnited States Conference of Catholic Bishops, “Prophetic Books”\rhttp://tinyurl.com/nfwu9w9\r\r\r",
                           @"category":@"Biblical"}];
    
    [TAWord wordWithDict:@{@"name":@"Philosophy",
                           @"twitterDef":@"the critical examination of human thought;\rthe love of wisdom",
                           @"definition":@"\rPhilosophy in the Western tradition originated in ancient Greece. As a discipline, Philosophy has an authentic independence from Theology. Among contemporary Catholic theologians, Fr. Thomas Guarino has explored the relationship between the two.\r\rFurther Reference:\rWikipedia, “Philosophy”\rhttp://tinyurl.com/e5h6u\r\r\r",
                           @"category":@"Cultural"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Physicalism",
                           ...
                           @"definition":@"\rPhysicalism has received from support from modern neuroscience. Various Christian philosophers, such as Nancy Murphy, are advocates of a non-reductive, physicalist anthropology.\r\rFurther Reference:\rNancey Murphy, “Is Non-Reductive Physicalism an Oxymoron?”\rhttp://tinyurl.com/po8oo85\r\r\r",
                           @"category":@"Cultural"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Problem of Evil",
                           ...
                           @"definition":@"\rThe Problem of Evil can be traced to the writings of the Greek philosopher Epicurus. It takes two forms: logical and evidential. The former results from belief in Divine omniscience, omnipotence, and omnibenevolence and the experience of suffering and evil in the world producing a logical inconsistency. It proposes the question: if God is all-loving, all-knowing, and all-powerful, why does evil (particularly so-called natural evil) exist? If not seen as logically incompatible, the evidential form of the Problem of Evil claims that such evil severely lowers the probability of the truth of Theism. See “Omnibenevolence”, “Omniscience”, “Omnipotence”, “Theism”, “Theodicy”.\r\rFurther Reference:\rStanford Encyclopedia of Philosophy, “The Problem of Evil”\rhttp://tinyurl.com/mvkoe4\r\r\r",
                           @"category":@"Cultural"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Quintessence",
                           ...
                           @"definition":@"\rAs part of his metaphysics, Aristotle posited a 5th essence or element that permeated the Divine realm; also known as “aether”.\r\rFurther Reference:\rWikipedia, “Aether”\rhttp://tinyurl.com/olx6j\r\r\r",
                           @"category":@"Cultural"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Redaction Criticism",
                           ...
                           @"definition":@"\rRedaction Criticism is primarily used in studies of the Gospels. It is specifically mentioned as a criticsm used as part of the larger Historical-Critical Method by the Pontifical Biblical Commission.\r\rFurther Reference:\rPontifical Biblical Commission, “The Interpretation of the Bible in the Church, I.A.2.” http://tinyurl.com/ymsltv\r\r\r",
                           @"category":@"Biblical"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Redemption",
                           ...
                           @"definition":@"\rThe biblical tradition is replete with the metaphor of redemption being applied to God's salvation of Israel and the Church.\r\rFurther Reference:\rWikipedia, “Redemption”\rhttp://tinyurl.com/pdfdqtt\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Rosary",
                           ...
                           @"definition":@"\rThe Rosary dates back to the time of St. Dominic in which the praying of 50 Hail Marys was popular.\r\rFurther Reference:\rWikipedia, “Rosary”\rhttp://tinyurl.com/55f737\r\r\r",
                           @"category":@"Cultural"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Soteriology",
                           ...
                           @"definition":@"\rSoteriology examines the nature of salvation using various .\r\rFurther Reference:\rWikipedia, “Soteriology”\rhttp://tinyurl.com/m3ysznn\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Synchronic Analysis",
                           ...
                           @"definition":@"\rSynchronic methods of Literary Criticism include Rhetorical, Narrative, and Semiotic Analysis.\r\rFurther Reference:\rPontifical Biblical Commission, “The Interpretation of the Bible in the Church, I.B”\rhttp://tinyurl.com/ymsltv\r\r\r",
                           @"category":@"Biblical"}];
    
    [TAWord wordWithDict:@{@"name":@"Synoptic Gospels",
                           @"twitterDef":@"the gospels of Matthew, Mark, and Luke",
                           @"definition":@"\rThe gospels of Matthew, Mark, and Luke are grouped together due to their similarity of narrative and low Christology contrasted with that of the gospel of John. The Two-Source Theory explains their relationship. See “Christology”, “Two-Source Theory”.\r\rGreek, σύνοψις (synopsis) “seeing together”\r\rFurther Reference:\rWikipedia, “Synoptic Gospels”\rhttp://tinyurl.com/aofv2x\r\r\r",
                           @"category":@"Biblical"}];
    ...
    */
    ...
    [TAWord wordWithDict:@{@"name":@"Solidarity",
                           ...
                           @"definition":@"\rSolidarity is a basic principle of Catholic Social Teaching.\r\rFurther Reference:\rCatechism of the Catholic Church, 1939\rhttp://tinyurl.com/cu6e64y\r\r\r",
                           @"category":@"Cultural"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Universal Destination of Goods",
                           ...
                           @"definition":@"\rThe Universal Destination of Goods has its roots in the Patristic interpretation of Scripture. According to the consent of the Fathers, the will of the Creator is that the gifts of Creation should be justly distributed among humankind.\r\rFurther Reference:\rThe Compendium of the Social Doctrine of the Church, 171\r\r\r",
                           @"category":@"Moral"}];
    
    [TAWord wordWithDict:@{@"name":@"Universalism",
                           @"twitterDef":@"the belief that all of humanity will ultimately be saved",
                           @"definition":@"\rThe belief that all of humanity will ultimately experience salvation. See “Apocatastasis”.\r\rFurther Reference:\rWikipedia, “Universal Reconciliation”\rhttp://tinyurl.com/yc3tt7h\r\r\r",
                           @"category":@"Systematic"}];
    ...
    [TAWord wordWithDict:@{@"name":@"Vulgate",
                           ...
                           @"definition":@"\rThe Vulgate was initially translated by St. Jerome. It was adopted as the official bible of the Roman Catholic Church at the Council of Trent. See “Trent” in the Historical section of the Maps tab. See “Bible”.\r\rFurther Reference:\rWikipedia, “Vulgate” http://tinyurl.com/ywebum\r\r\r",
                           @"category":@"Biblical"}];
