...
-(void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    else if ([segue.identifier isEqualToString:@"fathersDetail"])
    {
        ...
        liturgySource.comment = @"\rIn its broadest sense, Liturgy is the participation of the Church in the Paschal Mystery. More colloquially, the public worship of the Church is commonly referred to as Liturgy. The daily worship of the Church is known as the Liturgy of the Hours. The Sunday Mass is composed of the Liturgy of the Word and the Liturgy of the Eucharist.\r\rThe Liturgy of the Church expresses what it believes. This is known as the principle of Lex Orandi-Lex Credendi (“the law of prayer is the law of belief”). Liturgy is a source for Theology for precisely this reason. The Constitution on the Sacred Liturgy is the most authoritative teaching by the Church on the Liturgy. ";
